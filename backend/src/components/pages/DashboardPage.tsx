  ...
  return (
    <div className="p-6 md:p-8 space-y-6 bg-[#070a12] min-h-screen text-slate-100 animate-fade-in select-none">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Active Pipeline */}
        <div className="p-5 bg-[#0e1322] border border-slate-800/90 rounded-2xl shadow-xl flex flex-col justify-between card-spotlight hover:border-indigo-500/40 transition-all">
          ...
          <div className="flex items-center justify-between mt-3 pt-2 border-t border-slate-800/60 text-[11px]">
            ...
            <button onClick={() => navigate('/leads')} className="text-indigo-400 font-bold hover:underline flex items-center gap-0.5 cursor-pointer">
              View &gt;
            </button>
          </div>
        </div>
        ...
        {/* Closed Revenue */}
        <div className="p-5 bg-[#0e1322] border border-slate-800/90 rounded-2xl shadow-xl flex flex-col justify-between card-spotlight hover:border-emerald-500/40 transition-all">
          <div className="flex items-center justify-between">
        ...
        {/* Sent Proposals */}
        <div className="p-5 bg-[#0e1322] border border-slate-800/90 rounded-2xl shadow-xl flex flex-col justify-between card-spotlight hover:border-purple-500/40 transition-all">
          <div className="flex items-center justify-between">
        ...
        {/* Pending Tasks */}
        <div className="p-5 bg-[#0e1322] border border-slate-800/90 rounded-2xl shadow-xl flex flex-col justify-between card-spotlight hover:border-amber-500/40 transition-all">
          <div className="flex items-center justify-between">
