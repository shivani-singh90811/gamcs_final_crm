...
export const ProposalsPage: React.FC<ProposalsPageProps> = ({ onShowToast: externalShowToast }) => {
  ...
  const [formData, setFormData] = useState<{
    ...
    leadPartner: user?.name || 'Sarah Jenkins',
    contractFormat: 'RETAINER_CONTRACT',
    validUntil: '2026-09-30',
    startDate: '2026-08-01',
    endDate: '2027-07-31',
    executiveSummary: 'Archicorp Practice will provide executive fractional CFO leadership, Series C capital restructuring modeling, and tax credit optimization.',
    scopeOfWork: 'Phase 1: Valuation & Capital Model Restructuring\nPhase 2: Virtual Data Room Deployment for investors\nPhase 3: Executive Board & Audit Presentation',
    termsAndConditions: DEFAULT_TERMS_BY_FORMAT['RETAINER_CONTRACT'],
    notes: 'High priority client preparing for Series C venture round.',
    clientNotes: 'Please disburse invoices directly to Dr. Marcus Vance with CC to Finance Director.',
    status: 'DRAFT',
    items: [
      { id: 'item-1', description: 'Fractional CFO Executive Retainer (Monthly)', quantity: 3, rate: 25000, total: 75000 },
      { id: 'item-2', description: 'Series C M&A Valuation & Cap Table Modeling', quantity: 40, rate: 350, total: 14000 },
    ],
  });
  ...
  const handleOpenCreateModal = () => {
    setFormData({
      title: 'Fractional CFO & Capital Restructuring Engagement',
      clientName: 'Starlight BioTech Corp',
      clientCompany: 'Starlight BioTech Corporation',
      contactEmail: 'm.vance@starlightbio.io',
      clientPhone: '+1 (415) 890-2100',
