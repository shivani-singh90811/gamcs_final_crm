        ...
        <div className="space-y-6 animate-fade-in">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="p-5 bg-slate-900/90 border border-slate-800 rounded-2xl shadow-xl backdrop-blur-md">
              ...
              <p className="text-2xl font-black text-blue-400 mt-1">$1,250,000</p>
              <span className="text-[10px] font-bold text-slate-400 mt-2 block">Starlight BioTech Corp</span>
            </div>
