...
import {
  Users, Plus, Search, Mail, Phone, Calendar, Edit2, Trash2, X, Loader2, CheckCircle2
} from 'lucide-react';
            ...
            >
              ...
              <div className="flex items-center justify-end gap-2 pt-3 border-t border-slate-800/60">
                <button
                  ...
                  className="px-3 py-1 bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-800 rounded-lg text-xs font-semibold flex items-center gap-1 transition-colors"
                >
                  <Edit2 className="w-3 h-3 text-indigo-400" /> Edit
                </button>
                <button
                  onClick={() => setDeleteContactId(contact.id)}
                  className="px-3 py-1 bg-rose-950/40 hover:bg-rose-900/60 text-rose-300 border border-rose-800/60 rounded-lg text-xs font-semibold flex items-center gap-1 transition-colors"
                >
